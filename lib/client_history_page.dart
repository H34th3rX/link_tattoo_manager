...
// Using the same constants as client_profile_page for consistency
...
class _ClientHistoryPageState extends State<ClientHistoryPage> with TickerProviderStateMixin {
  ...
  // Simulated complete history data
  ...
  void _initializeHistoryData() {
    // Simulated complete history with various statuses
    _completeHistory = [
      {
        'id': '1',
        'type': 'Tatuaje',
        ...
        'status': 'Completado',
        'duration': '3 horas',
        'notes': 'Cliente muy satisfecho con el resultado. Cicatrización perfecta.',
      },
      {
        'id': '2',
        'type': 'Tatuaje',
        ...
        'status': 'Completado',
        'duration': '2.5 horas',
        'notes': 'Diseño personalizado. Cliente regresó para retoque menor.',
      },
      {
        'id': '3',
        'type': 'Consulta',
        'name': 'Consulta inicial - Diseño espalda',
        'artist': 'Miguel Torres',
        'date': '2023-06-10',
        'price': 0,
        'status': 'Completado',
        'duration': '1 hora',
        'notes': 'Discusión sobre diseño complejo para la espalda. Presupuesto: \$800.',
      },
      {
        'id': '4',
        'type': 'Cita',
        'name': 'Dragón en la espalda - Sesión 1',
        'artist': 'Miguel Torres',
        'date': '2024-03-15',
        'price': 400,
        'status': 'Pendiente',
        'duration': '4 horas',
        'notes': 'Primera sesión del diseño grande. Se requieren 3 sesiones más.',
      },
      {
        'id': '5',
        'type': 'Tatuaje',
        'name': 'Símbolo en la muñeca',
        'artist': 'Carlos Mendoza',
        'date': '2023-03-20',
        'price': 120,
        'status': 'Cancelado',
        'duration': '1 hora',
        'notes': 'Cliente canceló por motivos personales. Depósito reembolsado.',
      },
      {
        'id': '6',
        'type': 'Retoque',
        'name': 'Retoque mariposa',
        'artist': 'Ana Ruiz',
        'date': '2023-09-15',
        'price': 0,
        'status': 'Completado',
        'duration': '30 min',
        'notes': 'Retoque gratuito incluido en garantía.',
      },
    ];
    ...
    _historyStats = {
      ...
      'total_spent': _completeHistory
          .where((item) => item['status'] == 'Completado')
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Registro completo de servicios y citas',
                  style: TextStyle(
                    fontSize: 14,
  ...
  Widget _buildHistoryList(bool isDark, bool isWide) { // Added isWide parameter
  ...
  Widget _buildHistoryCard(Map<String, dynamic> item, bool isDark, bool isWide) { // Added isWide parameter
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            isWide
                ? Column( // Para pantallas anchas, usa dos filas con dos elementos cada una
                    children: [
                      Row(
                        children: [
                          Expanded(
                            child: _buildDetailItem(Icons.person, 'Artista', item['artist'], isDark),
                          ),
                          Expanded(
                            child: _buildDetailItem(Icons.calendar_today, 'Fecha', _formatDate(item['date']), isDark),
                          ),
                        ],
                      ),
                      const SizedBox(height: 12),
                      Row(
                        children: [
                          Expanded(
                            child: _buildDetailItem(Icons.access_time, 'Duración', item['duration'], isDark),
                          ),
                          Expanded(
                ...
                : Column( // Para pantallas estrechas, apila todos los elementos en una sola columna
                    children: [
                      _buildDetailItem(Icons.person, 'Artista', item['artist'], isDark),
                      const SizedBox(height: 12), // Espaciado entre elementos en columna única
